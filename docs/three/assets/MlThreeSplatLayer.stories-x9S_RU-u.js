import{ao as ve,ap as Te,aq as L,ar as be,as as we,at as Ce,ag as I,au as Se,av as ge,aw as pe,ax as ke,ay as he,az as ze,aA as Me,aB as oe,E as Ae,g as _,Q as de,f as K,aC as Ie,aD as $,aE as _e,r as E,aa as De,ab as Ee,V as q,aF as Z,aG as Pe,aH as X,o as F,aI as He,aJ as Ue,p as ie,aK as Re,aL as Ve,z as Be,B as Le,aM as Fe,h as Oe,aN as Ge,aO as Ne,w as We,aP as qe,L as me,F as xe,X as O,ae as fe,af as te,ah as je,ai as $e,aj as Ze,ak as Xe,al as Ye,am as Qe,an as Je}from"./ThreeObjectControls-Bdpd5sfi.js";import{r as b}from"./iframe-wUFsudfQ.js";import"./preload-helper-D9Z9MdNV.js";import"./index-lx3VtKdB.js";function Ke(l){return Te("MuiLink",l)}const et=ve("MuiLink",["root","underlineNone","underlineHover","underlineAlways","button","focusVisible"]),tt=({theme:l,ownerState:e})=>{const t=e.color;if("colorSpace"in l&&l.colorSpace){const a=L(l,`palette.${t}.main`)||L(l,`palette.${t}`)||e.color;return l.alpha(a,.4)}const s=L(l,`palette.${t}.main`,!1)||L(l,`palette.${t}`,!1)||e.color,r=L(l,`palette.${t}.mainChannel`)||L(l,`palette.${t}Channel`);return"vars"in l&&r?`rgba(${r} / 0.4)`:be(s,.4)},le={primary:!0,secondary:!0,error:!0,info:!0,success:!0,warning:!0,textPrimary:!0,textSecondary:!0,textDisabled:!0},st=l=>{const{classes:e,component:t,focusVisible:s,underline:r}=l,a={root:["root",`underline${pe(r)}`,t==="button"&&"button",s&&"focusVisible"]};return ke(a,Ke,e)},at=Se(he,{name:"MuiLink",slot:"Root",overridesResolver:(l,e)=>{const{ownerState:t}=l;return[e.root,e[`underline${pe(t.underline)}`],t.component==="button"&&e.button]}})(ze(({theme:l})=>({variants:[{props:{underline:"none"},style:{textDecoration:"none"}},{props:{underline:"hover"},style:{textDecoration:"none","&:hover":{textDecoration:"underline"}}},{props:{underline:"always"},style:{textDecoration:"underline","&:hover":{textDecorationColor:"inherit"}}},{props:({underline:e,ownerState:t})=>e==="always"&&t.color!=="inherit",style:{textDecorationColor:"var(--Link-underlineColor)"}},{props:({underline:e,ownerState:t})=>e==="always"&&t.color==="inherit",style:l.colorSpace?{textDecorationColor:l.alpha("currentColor",.4)}:null},...Object.entries(l.palette).filter(Me()).map(([e])=>({props:{underline:"always",color:e},style:{"--Link-underlineColor":l.alpha((l.vars||l).palette[e].main,.4)}})),{props:{underline:"always",color:"textPrimary"},style:{"--Link-underlineColor":l.alpha((l.vars||l).palette.text.primary,.4)}},{props:{underline:"always",color:"textSecondary"},style:{"--Link-underlineColor":l.alpha((l.vars||l).palette.text.secondary,.4)}},{props:{underline:"always",color:"textDisabled"},style:{"--Link-underlineColor":(l.vars||l).palette.text.disabled}},{props:{component:"button"},style:{position:"relative",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none","&::-moz-focus-inner":{borderStyle:"none"},[`&.${et.focusVisible}`]:{outline:"auto"}}}]}))),rt=b.forwardRef(function(e,t){const s=we({props:e,name:"MuiLink"}),r=Ce(),{className:a,color:o="primary",component:u="a",onBlur:h,onFocus:p,TypographyClasses:d,underline:c="always",variant:n="inherit",sx:m,...i}=s,[v,S]=b.useState(!1),T=y=>{oe(y.target)||S(!1),h&&h(y)},w=y=>{oe(y.target)&&S(!0),p&&p(y)},C={...s,color:o,component:u,focusVisible:v,underline:c,variant:n},g=st(C);return I.jsx(at,{color:o,className:ge(g.root,a),classes:d,component:u,onBlur:T,onFocus:w,ref:t,ownerState:C,variant:n,...i,sx:[...le[o]===void 0?[{color:o}]:[],...Array.isArray(m)?m:[m]],style:{...i.style,...c==="always"&&o!=="inherit"&&!le[o]&&{"--Link-underlineColor":tt({theme:r,ownerState:C})}}})});function se(l,e,t){try{const s=l.next();s.done||!s.value?e(s):s.value.then(()=>e({done:s.done,value:void 0}),t)}catch(s){t(s)}}function ae(l=25){let e;return(t,s,r)=>{const a=performance.now();e===void 0||a-e>l?(e=a,setTimeout(()=>se(t,s,r),0)):se(t,s,r)}}function ye(l,e,t,s,r){const a=()=>{let o;const u=h=>{h.done?t(h.value):o===void 0?o=!0:a()};do{if(o=void 0,r?.aborted){s(new DOMException("Aborted","AbortError"));return}e(l,u,s),o===void 0&&(o=!1)}while(o)};a()}function nt(l,e){let t;return ye(l,se,s=>{t=s},s=>{throw s},e),t}function re(l,e,t){return new Promise((s,r)=>{ye(l,e,s,r,t)})}const ot=`
...
`))if(T.startsWith("property ")){const[,w,C]=T.split(" "),g={value:k.valueNameToEnum(C),type:k.typeNameToEnum(w),offset:n===1?i:m};n===1?(S.push(g),i+=d[w]??0):(v.push(g),m+=d[w]??0)}else if(T.startsWith("element ")){const[,w]=T.split(" ");n=w==="chunk"?1:0}return{vertexCount:u,chunkCount:p,rowVertexLength:m,rowChunkLength:i,vertexProperties:v,chunkProperties:S,dataView:new DataView(e,a+r.length),buffer:new ArrayBuffer(k.ROW_OUTPUT_LENGTH*u)}}}const ne=l=>{const{url:e,position:t,mapPosition:s,altitude:r,rotation:a,scale:o,enableTransformControls:u,transformMode:h,onTransformChange:p,init:d,onDone:c}=l,{scene:n,worldMatrixInv:m}=fe(),i=b.useRef(void 0),[v,S]=b.useState(void 0),T=b.useRef(d),w=b.useRef(c);T.current=d,w.current=c;const C=b.useRef({position:t,mapPosition:s,altitude:r,rotation:a,scale:o});C.current={position:t,mapPosition:s,altitude:r,rotation:a,scale:o};const g=b.useRef(m);return g.current=m,b.useEffect(()=>{if(!n)return;typeof T.current=="function"&&T.current();const y=e.split(".").pop()?.toLowerCase(),f=x=>{const{position:z,mapPosition:U,altitude:B,rotation:R,scale:A}=C.current,W=g.current;if(U&&W){const V=te.toScenePosition(W,U,B);x.position.set(V.x,V.y,V.z)}else z&&x.position.set(z.x,z.y,z.z);R&&x.rotation.set(R.x,R.y,R.z),A&&(typeof A=="number"?x.scale.set(A,A,A):x.scale.set(A.x,A.y,A.z)),x.updateMatrixWorld(!0),i.current=x,n.add(x),S(x),typeof w.current=="function"&&w.current()};return y==="splat"?new lt().load(e,z=>{f(z)}):y==="ply"?new k().load(e,z=>{f(z)}):console.warn("MlThreeSplatLayer: Unsupported file extension",y),()=>{i.current&&(n.remove(i.current),"dispose"in i.current&&typeof i.current.dispose=="function"&&i.current.dispose(),i.current=void 0,S(void 0))}},[n,e]),b.useEffect(()=>{if(v){if(s&&m){const y=te.toScenePosition(m,s,r);v.position.set(y.x,y.y,y.z)}else t&&v.position.set(t.x,t.y,t.z);a&&v.rotation.set(a.x,a.y,a.z),o&&(typeof o=="number"?v.scale.set(o,o,o):v.scale.set(o.x,o.y,o.z)),v.updateMatrixWorld(!0)}},[v,t,s,r,a,o,m]),u&&v?I.jsx(je,{target:v,mode:h,onObjectChange:p}):null};ne.__docgenInfo={description:"",methods:[],displayName:"MlThreeSplatLayer",props:{mapId:{required:!1,tsType:{name:"string"},description:""},url:{required:!0,tsType:{name:"string"},description:""},position:{required:!1,tsType:{name:"signature",type:"object",raw:"{ x: number; y: number; z: number }",signature:{properties:[{key:"x",value:{name:"number",required:!0}},{key:"y",value:{name:"number",required:!0}},{key:"z",value:{name:"number",required:!0}}]}},description:""},mapPosition:{required:!1,tsType:{name:"LngLatLike"},description:""},altitude:{required:!1,tsType:{name:"number"},description:""},rotation:{required:!1,tsType:{name:"signature",type:"object",raw:"{ x: number; y: number; z: number }",signature:{properties:[{key:"x",value:{name:"number",required:!0}},{key:"y",value:{name:"number",required:!0}},{key:"z",value:{name:"number",required:!0}}]}},description:""},scale:{required:!1,tsType:{name:"union",raw:"{ x: number; y: number; z: number } | number",elements:[{name:"signature",type:"object",raw:"{ x: number; y: number; z: number }",signature:{properties:[{key:"x",value:{name:"number",required:!0}},{key:"y",value:{name:"number",required:!0}},{key:"z",value:{name:"number",required:!0}}]}},{name:"number"}]},description:""},enableTransformControls:{required:!1,tsType:{name:"boolean"},description:""},transformMode:{required:!1,tsType:{name:"union",raw:"'translate' | 'rotate' | 'scale'",elements:[{name:"literal",value:"'translate'"},{name:"literal",value:"'rotate'"},{name:"literal",value:"'scale'"}]},description:""},onTransformChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(object: THREE.Object3D) => void",signature:{arguments:[{type:{name:"THREE.Object3D"},name:"object"}],return:{name:"void"}}},description:""},init:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onDone:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const ft={title:"MapComponents/MlThreeSplatLayer",component:ne,argTypes:{options:{control:{type:"object"}}},decorators:$e},pt=()=>{const{worldMatrix:l}=fe(),[e,t]=b.useState(!0),[s,r]=b.useState(100),[a,o]=b.useState({x:270,y:0,z:5}),[u,h]=b.useState(!0),[p,d]=b.useState({lng:7.0968,lat:50.736}),[c,n]=b.useState(30),[m,i]=b.useState({x:0,y:0,z:100}),[v,S]=b.useState(!1),[T,w]=b.useState("translate"),[C,g]=b.useState(!0),y=Ze({mapId:"map_1"});b.useEffect(()=>{y.map&&(y.map?.setZoom(17.5),y.map?.setPitch(44.5),y.map?.setCenter([7.096614581535903,50.736500960686556]))},[y.map]),b.useEffect(()=>{y.map&&u&&y.map.setCenter([p.lng,p.lat])},[u,y.map]);const f=x=>{if(o({x:x.rotation.x*180/Math.PI,y:x.rotation.y*180/Math.PI,z:x.rotation.z*180/Math.PI}),r(x.scale.x),u&&l){const[z,U,B]=te.toMapPosition(l,x.position);d({lng:z,lat:U}),n(parseFloat(B.toFixed(2)))}else i({x:x.position.x,y:x.position.y,z:x.position.z})};return I.jsxs(I.Fragment,{children:[e&&I.jsx(ne,{url:"assets/splats/output.splat",rotation:{x:a.x*Math.PI/180,y:a.y*Math.PI/180,z:a.z*Math.PI/180},scale:s,enableTransformControls:v,transformMode:T,onTransformChange:f,...u?{mapPosition:[p.lng,p.lat],altitude:c}:{position:m}}),I.jsx(Xe,{unmovableButtons:I.jsx(Ye,{variant:C?"contained":"outlined",onClick:()=>g(!C),children:"Sidebar"})}),I.jsxs(Qe,{open:C,setOpen:g,name:"Splat Config",children:[I.jsx(Je,{showLayer:e,setShowLayer:t,scale:s,setScale:r,rotation:a,setRotation:o,useMapCoords:u,setUseMapCoords:h,mapPosition:p,setMapPosition:d,altitude:c,setAltitude:n,position:m,setPosition:i,enableTransformControls:v,setEnableTransformControls:S,transformMode:T,setTransformMode:w,layerName:"Splat"}),I.jsxs(he,{variant:"body2",sx:{mt:2,p:1,backgroundColor:"rgba(255,255,255,0.1)",borderRadius:1},children:["The splat used is from"," ",I.jsx(rt,{href:"https://www.patreon.com/posts/cluster-fly-141866089",target:"_blank",rel:"noopener",children:"Cluster Fly"})," ","by Dany Bittel published under CC."]})]})]})},j=pt.bind({});j.parameters={};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`() => {
  const {
    worldMatrix
  } = useThree();
...
}`,...j.parameters?.docs?.source}}};const yt=["Default"];export{j as Default,yt as __namedExportsOrder,ft as default};
