import{j as e}from"./index-CmvxiA_N.js";import{g as h,M as b,be as y,bf as g,T as w,a as v,Y as x,bg as o,bh as d,bi as u,S as p,p as r,bj as c}from"./style-DGSU19-Y.js";import{r as C}from"./iframe-BZf6mwbH.js";import{s as V}from"./sample_polygon_1-C4T77cfz.js";import"./index-NYlob9aH.js";import"./preload-helper-D9Z9MdNV.js";const l=t=>[(i,s)=>{const m=C.useMemo(()=>h(s?.globals?.theme),[s?.globals?.theme]);return e.jsx("div",{className:"fullscreen_map",children:e.jsx(b,{children:e.jsx(y,{store:g,children:e.jsxs(w,{theme:m,children:[e.jsx(i,{}),e.jsx(v,{options:{zoom:12.5,style:"https://wms.wheregroup.com/tileserver/style/osm-bright.json",center:[7.0851268,50.73884],...t?{...t}:{}},mapId:"map_1"}),e.jsx(x,{showZoomButtons:!1,mapId:"map_1"})]})})})})}],T=l({});try{l.displayName="makeMapContextDecorators",l.__docgenInfo={description:"",displayName:"makeMapContextDecorators",props:{hash:{defaultValue:null,description:`If \`true\`, the map's position (zoom, center latitude, center longitude, bearing, and pitch) will be synced with the hash fragment of the page's URL.
...
keep the camera above ground when pitch \\> 90 degrees.`,name:"centerClampedToGround",required:!1,type:{name:"boolean | undefined"}}}}}catch{}const L="FeatureCollection",k=[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.087102928817649,50.74405832491909]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.08709100837143,50.74248301217495]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.087340096598094,50.743463230859554]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.085715859711298,50.74413132961715]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.087048180788789,50.744208881351355]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.085567870742217,50.74411037418911]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.085626894551625,50.74326065094446]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.086857240792656,50.74322306548407]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.086775098221696,50.74235433252242]}},{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[7.086770996718059,50.74374476917342]}}],f={type:L,features:k},O={title:"UiComponents/LayerTree",component:o,argTypes:{},decorators:T},j=()=>{const t={mapConfigs:{mapConfig1:{name:"Demo Map",mapProps:{center:[7.0851268,50.73884],zoom:12},layers:[{type:"folder",uuid:"acd3d99f-2f82-40a5-a5c9-f303d54f5606",name:"layers in a folder",visible:!0},{type:"geojson",uuid:"fec837fa-1d5d-432b-89c2-b416c9773523",name:"Example Point Layer",configurable:!0,config:{geojson:f}},{type:"vt",uuid:"346ced38-142c-4b57-8193-d689ffc7dfc2",name:"Vector Layer",visible:!0,config:{layers:[{id:"7feaa47a-f667-49ee-9780-312eabaa872b",type:"fill","source-layer":"water",source:"openmaptiles",layout:{visibility:"visible"},paint:{"fill-color":"#0905f5","fill-opacity":.5},maxzoom:20},{id:"346ced38-142c-4b57-8193-d689ffc7dfc2",type:"fill","source-layer":"building",source:"openmaptiles",layout:{visibility:"none"},paint:{"fill-color":"#717875"},maxzoom:20}],sourceOptions:{type:"vector",minzoom:0,tiles:["https://wms.wheregroup.com/tileserver/tile/world-0-14/{z}/{x}/{y}.pbf"]}}},{type:"wms",uuid:"0e8cd91b-bd49-419d-a19a-5b15dec17542",name:"Example WMS Layer",config:{url:"https://www.wms.nrw.de/geobasis/wms_nw_uraufnahme",urlParameters:{layers:"nw_uraufnahme_rw"}}}],layerOrder:[{uuid:"acd3d99f-2f82-40a5-a5c9-f303d54f5606",layers:[{uuid:"fec837fa-1d5d-432b-89c2-b416c9773523"},{uuid:"346ced38-142c-4b57-8193-d689ffc7dfc2"},{uuid:"0e8cd91b-bd49-419d-a19a-5b15dec17542"}]}]}}};return d()(u({key:"mapConfig1",mapConfig:t.mapConfigs.mapConfig1})),e.jsxs(e.Fragment,{children:[e.jsxs(p,{open:!0,children:[e.jsx(r,{variant:"h5",children:"Example Layertree"}),e.jsx(o,{mapConfigKey:Object.keys(t.mapConfigs)[0]})]}),e.jsx(c,{mapConfigKey:Object.keys(t.mapConfigs)[0]})]})},a=j.bind({});a.parameters={};a.args={};const q=()=>{const t={mapConfigs:{mapConfig1:{name:"Demo Map",mapProps:{center:[7.0851268,50.73884],zoom:12},layers:[{type:"folder",uuid:"acd3d99f-2f82-40a5-a5c9-f303d54f5606",name:"layers in a folder",visible:!0,config:void 0},{type:"geojson",uuid:"fec837fa-1d5d-432b-89c2-b416c9773523",name:"Example Point Layer",configurable:!0,config:{type:"circle",geojson:f,options:{paint:{"circle-color":"blue","circle-radius":5}}}},{type:"geojson",uuid:"0587c0ed-aaa0-4315-bb77-a40937a684d7",name:"Example Polygon Layer",configurable:!0,config:{geojson:V,options:{paint:{"fill-color":"red"}}}}],layerOrder:[{uuid:"acd3d99f-2f82-40a5-a5c9-f303d54f5606",layers:[{uuid:"fec837fa-1d5d-432b-89c2-b416c9773523"},{uuid:"0587c0ed-aaa0-4315-bb77-a40937a684d7"}]}]}}};return d()(u({key:"mapConfig1",mapConfig:t.mapConfigs.mapConfig1})),e.jsxs(e.Fragment,{children:[e.jsxs(p,{open:!0,children:[e.jsx(r,{variant:"h5",children:"Layertree 1"}),e.jsx(o,{mapConfigKey:Object.keys(t.mapConfigs)[0]}),e.jsx(r,{variant:"h5",children:"Layertree 2"}),e.jsx(o,{mapConfigKey:Object.keys(t.mapConfigs)[0]})]}),e.jsx(c,{mapConfigKey:Object.keys(t.mapConfigs)[0]})]})},n=q.bind({});n.parameters={};n.args={};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`() => {
...
}`,...n.parameters?.docs?.source}}};const D=["LayerTreeMultipleLayertypesExample","MultipleLayertreesExample"];export{a as LayerTreeMultipleLayertypesExample,n as MultipleLayertreesExample,D as __namedExportsOrder,O as default};
