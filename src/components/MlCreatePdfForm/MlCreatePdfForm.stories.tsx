				...
				<MlDialog title="Create PDF" mediaIsMobile={mediaIsMobile}>
					<MlCreatePdfForm
						...
						onCreatePdf={(options) => {
							...
							const centerX = pageHeight / 2;
							const centerY = pageWidth / 2;

							const title = options.formData.get('title') as string;
							const description = options.formData.get('description') as string;
							const offsetX = 42.5;
							const offsetY = 4.5;
							const linkOffsetY = 6;
							const titleOffsetY = 10;
							const titleOffsetX = 87.5;
							const marginTop = 3;
							const titleMarginTop = 1.5;
							const marginBottom = 3;
							const innerMargin = 2;
							const logo =
								'data:image/png;base64,';
							...
							*/
							...
							pdf.addImage(
								...
								'png',
								3,
								offsetY + logoHeight + textChunks.length * 3 + innerMargin * 2,
								6,
								6,
								undefined,
								'FAST'
							...
							pdf.text(title, titleX, titleOffsetY);

							//Add Description
							pdf.setFontSize(10);
							const maxWidth = isLandscape ? 240 : 180; // Adjust as needed
